#  SOME CHANGES TO THIS FILE WHERE MADE BY FREDERIK ESAU
...
draw_rectangle:
	...
	addi sp, sp, -40 ## CHANGED BY FREDERIK ESAU
	sw ra, (sp)
	sw s0, 4 (sp)
	sw s1, 8 (sp)
	sw s2, 12 (sp)
	...
	sw a6, 28 (sp)
	sw a7, 32 (sp)
	sw t1, 36 (sp) ## CHANGED BY FREDERIK ESAU
	...
	lw s1, 8 (sp)
	lw s2, 12 (sp)
	lw a3, 16(sp) ## CHANGED BY FREDERIK ESAU
	lw t1, 36(sp) ## CHANGED BY FREDERIK ESAU
